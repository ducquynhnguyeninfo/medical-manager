...
class PatientReportService {
    ...
    async reportPatientInDuration(from: Date, to: Date) {
        ...
        appointmentData.forEach(a => {
            ...
            count+=1;
            reportData.push(new PatientReportItemViewModel(count, a.AppointmentDate, a.EmployeeName, a.Department, a.EmployeeNumber, a.BeginTreatment, a.EndTreatment, a.Symptom, a.IsUseMedicine, a.IsUseMedicine, a.Note));
        });
