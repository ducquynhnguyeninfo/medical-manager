            ...
            <Grid container spacing={2}>
                <Grid item xs={12} container spacing={2}>
                    <Grid item xs={12} md={3}>
                        <DatePicker label="Ngày nhập" slotProps={{ textField: { size: "small", fullWidth: true } }} format="DD-MM-YYYY" value={dayjs(sInputOutputMedicine.ticket.InputDate)}
                            onChange={(value) => {
                                if (value != null)
                    ...
                    <Grid item xs={12} md={3}>
                        <TextField id="standard-basic" label="Email nhân viên nhập thuốc" fullWidth size="small" value={sInputOutputMedicine.ticket.InputUser || ""}
                ...
                <Grid item xs={12} md={6} container spacing={2}>
                    <Grid item xs={12}>
                        <TextField id="standard-basic" label="Lý do nhập thuốc" fullWidth size="small" value={sInputOutputMedicine.ticket.Reason || ""}
